...
export const metadata = {
  title: 'Manifold Showcase | Manifold-3D POC',
  description: 'Interactive demonstration of Manifold-3D boolean operations',
};

export default function ManifoldShowcasePage() {
  return (
